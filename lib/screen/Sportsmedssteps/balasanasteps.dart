...
class Balasana extends StatefulWidget {
  const Balasana({super.key});

  @override
  State<Balasana> createState() => _BalasanaState();
}

class _BalasanaState extends State<Balasana> {
        ...
        child: Column(
          ...
          children: [
            ...
            const MeditationStep(
              stepTitle: "Balasana (Child's Pose)",
              description: [
                "Balasana, or Child's Pose, is a resting posture that gently stretches the hips, thighs, and ankles, and calms the mind."
              ],
            ),
            const MeditationStep(
              stepTitle: "Step 1: Starting Position",
              description: [
                "Kneel on the floor, with your big toes touching and knees spread apart (or together if preferred).",
                "Sit back on your heels, resting your hips on your heels."
              ],
            ),
            const MeditationStep(
              stepTitle: "Step 2: Stretch Forward",
              description: [
                "Exhale and slowly fold your torso forward, bringing your forehead to the ground.",
                "Extend your arms forward, palms facing down, or place them by your sides with palms facing up."
              ],
            ),
            const MeditationStep(
              stepTitle: "Step 3: Relax the Body",
              description: [
                "Allow your chest to rest between your thighs, and let your head and neck relax completely.",
                "Feel the stretch along your spine, shoulders, and hips."
              ],
            ),
            const MeditationStep(
              stepTitle: "Step 4: Breathe Deeply",
              description: [
                "Take slow, deep breaths, allowing your body to sink deeper into the pose with each exhale.",
                "Stay in this posture for as long as comfortable, typically 30 seconds to a few minutes.",
              ],
            ),
            const MeditationStep(
              stepTitle: "Step 5: Release",
              description: [
                "Inhale and slowly lift your torso back up, returning to a seated kneeling position."
              ],
            ),
            const Padding(
              padding: EdgeInsets.all(10.0),
              child: Text(
                "Both of these poses promote balance and relaxation and are excellent additions to any meditation or yoga practice.",
