...
class ohmchantingsteps extends StatefulWidget {
  const ohmchantingsteps({super.key});

  @override
  State<ohmchantingsteps> createState() => _ohmchantingstepsState();
}

class _ohmchantingstepsState extends State<ohmchantingsteps> {
...
"Place your hands on your knees in a mudra or keep them relaxed.",
"Take a few deep breaths to center your mind and body.",],
            
            ),
            const MeditationStep(
              stepTitle: "Step 2:  Step 2: Breath Awareness",
              description: ["Focus on your breathing, inhaling deeply through your nose.",
"With each inhale, feel your abdomen expand, and with each exhale, feel it contract.",
"Continue this breath awareness to calm your mind.",
              ],
            ),
            const MeditationStep(
              stepTitle: "Step 3:Chanting 'Ohm'",
              description: ["Inhale deeply and as you exhale, begin to chant “Ohm” slowly and steadily."
"Allow the sound to resonate through your body, focusing on the vibration of each part:",
"'Ooo' – begins in your lower abdomen and chest.",
"'Mmm' – resonates in your head and throughout your skull.",
"Chant in a long, drawn-out manner, and when you finish, take a deep inhale and repeat.",
              ]
            
            ),
            const MeditationStep(
              stepTitle: "Step 4:Repeat the Chant",
              description: ["Continue chanting 'Ohm' for several rounds, keeping your focus on the sound and vibration.",
"You can chant aloud for the first few rounds, then silently chant internally as you go deeper into the meditation.",
              ]
            
            ),
             const MeditationStep(
              stepTitle: "Step 5:  Completion",
              description: ["After a few minutes, stop chanting and sit in silence.",
"Focus on the inner stillness and the lingering vibrations of the sound.",
"Slowly open your eyes, keeping the calm energy with you as you finish the practice.",
              ]
