...
import 'package:firebaseseries/screen/onboardingscreens/onboarding3.dart';
...
class _Onboarding2State extends State<Onboarding2>
  ...
  void initState() {
    ...
    _slideAnimation = Tween<Offset>(begin: const Offset(-1.0, 0), end: const Offset(0, 0))
                ...
                Column(
                  children: [
                    ...
                    SlideTransition(
                      position: _slideAnimation,
                      child: const Padding(
                        padding: EdgeInsets.only(top: 10, right: 105),
                        child: Text(
                          "Stressed",
                ...
                Column(
                  children: [
                    ...
                    SlideTransition(
                      position: _slideAnimation,
                      child: const Padding(
                        padding: EdgeInsets.only(right: 90, top: 3),
                        child: Text(
                          "Feeling good",
                          style: TextStyle(color: Colors.white54, fontSize: 12),
                        ),
                ...
                Column(
                  children: [
                    ...
                    SlideTransition(
                      position: _slideAnimation,
                      child: const Padding(
                        padding: EdgeInsets.only(right: 80, top: 3),
                        child: Text(
                          "Need to relax",
                          style: TextStyle(color: Colors.white54, fontSize: 12),
                        ),
                ...
                Column(
                  children: [
                    ...
                    SlideTransition(
                      position: _slideAnimation,
                      child: const Padding(
                        padding: EdgeInsets.only(right: 70, top: 3),
                        child: Text(
                          "Feeling excited",
                          style: TextStyle(color: Colors.white54, fontSize: 12),
                        ),
            ...
            Column(
              children: [
                ...
                SlideTransition(
                  position: _slideAnimation,
                  child: const Padding(
                    padding: EdgeInsets.only(top: 10, right: 320),
                    child: Text("Focused",
                        style: TextStyle(color: color9, fontSize: 12)),
                  ),
                ),
                SlideTransition(
                  position: _slideAnimation,
                  child: const Padding(
                    padding: EdgeInsets.only(right: 280, top: 3),
                    child: Text(
                      "Feeling focused",
                      style: TextStyle(color: Colors.white54, fontSize: 12),
                    ),
