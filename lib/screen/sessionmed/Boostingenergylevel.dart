...
import 'package:firebaseseries/screen/Sportsmedssteps/suryanamaskar.dart';
...
class boostingmeditation extends StatefulWidget {
  const boostingmeditation({super.key});

  @override
  State<boostingmeditation> createState() => _boostingmeditationState();
}

class _boostingmeditationState extends State<boostingmeditation> {
          ...
          body: SingleChildScrollView(
            child: Column(children: [
             ...
             ChoiceCard(
              ...
              description:
                  'Energizes the body and mind, increasing agility and mental alertness for soccer players.',
              onStart: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>suryanamaskar()));
              },
            ),
                    ],
                  ),
