...
import 'package:firebaseseries/screen/Sportsmedssteps/bhramaristeps.dart';
...
class overcomingfatique extends StatefulWidget {
  const overcomingfatique({super.key});

  @override
  State<overcomingfatique> createState() => _overcomingfatiqueState();
}

class _overcomingfatiqueState extends State<overcomingfatique> {
          ...
          body: SingleChildScrollView(
            child: Column(children: [
             ...
             ChoiceCard(
              ...
              description:
                  ' Reduces stress and mental fatigue, rejuvenating rugby players during half-time.',
              onStart: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>bhramaristeps()));
              },
            ),
                    ],
                  ),
