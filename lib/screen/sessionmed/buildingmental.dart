...
class buildingmeditation extends StatefulWidget {
  const buildingmeditation({super.key});

  @override
  State<buildingmeditation> createState() => _buildingmeditationState();
}

class _buildingmeditationState extends State<buildingmeditation> {
          ...
          body: SingleChildScrollView(
            child: Column(children: [
             ...
             ChoiceCard(
              ...
              title: "Warrior Poses Sequence(Virabhadrasana)",
              ...
              description:
                  'Builds strength, focus, and resilience, essential for rugby players facing a challenging season.',
              onStart: () {
