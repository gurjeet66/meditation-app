          ...
          body: SingleChildScrollView(
            child: Column(children: [
             ...
             ChoiceCard(
              ...
              title: "Dhyana(Meditation) with Trataka(Candle Gazing)",
              ...
              description:
                  'Enhance focus and mental clarity,ideal for golfers requiring precision and a calm mind.',
              onStart: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>dhayanamed()));
              },
            ),
                    ],
                  ),
