...
class mentalclarity extends StatefulWidget {
  const mentalclarity({super.key});

  @override
  State<mentalclarity> createState() => _mentalclarityState();
}

class _mentalclarityState extends State<mentalclarity> {
          ...
          body: SingleChildScrollView(
            child: Column(children: [
             ...
             ChoiceCard(
              ...
              description:
                  'Clears the mind and balances energy, promoting flexibility and focus for marathon runners.',
              onStart: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>anulomvilomsteps()));
              },
            ),
                    ],
                  ),
