...
class recoveryandrelaxation extends StatefulWidget {
  const recoveryandrelaxation({super.key});

  @override
  State<recoveryandrelaxation> createState() => _recoveryandrelaxationState();
}

class _recoveryandrelaxationState extends State<recoveryandrelaxation> {
          ...
          body: SingleChildScrollView(
            child: Column(children: [
             ...
             ChoiceCard(
              ...
              description:
                  ' Opens the chest and hips, promoting muscle recovery and relaxation after an intense swim.',
              onStart: () {
