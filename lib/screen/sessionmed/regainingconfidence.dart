...
import 'package:firebaseseries/screen/Sportsmedssteps/vrksasanasteps.dart';
...
class regainingconfidence extends StatefulWidget {
  const regainingconfidence({super.key});

  @override
  State<regainingconfidence> createState() => _regainingconfidenceState();
}

class _regainingconfidenceState extends State<regainingconfidence> {
          ...
          body: SingleChildScrollView(
            child: Column(children: [
             ...
             ChoiceCard(
              ...
              title: " Vrksasana (Tree Pose) with Visualization",
              ...
              description:
                  'Enhances focus and self-confidence, helping basketball players regain composure after missing a crucial shot.',
              onStart: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>vrksasana()));
              },
            ),
                    ],
                  ),
